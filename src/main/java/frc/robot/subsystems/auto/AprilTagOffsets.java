...
public enum AprilTagOffsets {
    ...
    NEUTRAL_EDGE_MID_FROM_LEFT(2.5, 0, -105),
    NEUTRAL_EDGE_MID_FROM_RIGHT(2.5, 0, 105),
    NEUTRAL_EDGE_LEFT(2.5, 2.75, -105),
    NEUTRAL_EDGE_RIGHT(2.5, -2.75, 105),
    NEUTRAL_CENTER_MID_FROM_LEFT(3, 0, -105),
    NEUTRAL_CENTER_MID_FROM_RIGHT(3, 0, 105),
    NEUTRAL_CENTER_LEFT(3, 2.75, -105),
    NEUTRAL_CENTER_RIGHT(3, -2.75, 105),
    // Climb Offsets
